...
tree = ET.parse('C:\\Users\\Jamshed_Rushdie\\Documents\\Output.xml')
...
p = text.findall("{urn:oasis:names:tc:opendocument:xmlns:text:1.0}p")
...
print(txt)
with open("Output.txt", 'w') as i: i.write(txt)
